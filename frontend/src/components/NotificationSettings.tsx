    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Process started</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Process stopped</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Process restarted</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Process crashed</span>
              <input
                type="checkbox"
        ...
        <div>
          ...
          <div className="space-y-3">
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">High CPU usage (&gt;80%)</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">High memory usage (&gt;90%)</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Low disk space (&lt;10%)</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Network connectivity issues</span>
              <input
                type="checkbox"
        ...
        <div>
          ...
          <div className="space-y-3">
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Slow response times (&gt;2s)</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">High latency spikes</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Error rate spikes</span>
              <input
                type="checkbox"
        ...
        <div>
          ...
          <div className="space-y-3">
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">System updates available</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Backup completion</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700 dark:text-gray-300">Scheduled task execution</span>
              <input
                type="checkbox"
